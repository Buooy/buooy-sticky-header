...
# main config
PLUGINSLUG="buooy-sticky-header" # returns basename of current directory
CURRENTDIR='pwd'
MAINFILE="buooy-sticky-header" # this should be the name of your main php file in the wordpress plugin
SVNUSER="Buooy" # your svn username
